...
- feat(migrate): --isolate resets the shared tree per migration (IMP2, POM-contamination fix) (#260, 2026-06-28)
- feat(migrate): deterministic Cypress→Playwright codemod for the mechanical ~80% (BP6) (#258, 2026-06-28)
- feat(quality): calibrated LLM-judge for the non-executable axes (BP8) (#257, 2026-06-28)
- feat(cli): npm run migrate --repair — make the proven closed loop the default path (#256, 2026-06-28)
- feat(quality): per-framework promotion gate — make the 70% bar computable (wave-4 #1) (#250, 2026-06-25)
- feat(rag): offline ablation — is retrieval load-bearing or decorative? (wave-4) (#249, 2026-06-25)
- feat(cli): npm run plan — local Stage-1 so you can plan your OWN test (wave-4 #4) (#247, 2026-06-25)
- feat(scorer): reachable-POM scope — stop scoring dead/inherited shared-POM methods (wave-3 #3) (#243, 2026-06-24)
- feat(conformance): quality-defect class (W1/W2/W5/W15) blocks via --block-defects (wave-3 #2) (#242, 2026-06-24)
- feat(quality): source-equivalence gate — assertion coverage from the envelope (wave-3 #1) (#241, 2026-06-24)
- feat(quality): acceptance measurement infrastructure — rubric + Wilson CI + calibration (wave-2) (#240, 2026-06-24)
- feat(ci): make DOM grounding the default — capture pre-generate, gate offline (#234, 2026-06-22)
- feat(grounding): offline abstention gate — refuse confident hallucinations without a SUT (lever 1) (#233, 2026-06-22)
- feat(conformance): W15 — shared page load gate must not gate on scenario content (lever 3) (#232, 2026-06-22)
- feat(grounding): feed the DOM into Stage 2 as a closed vocabulary (#231, 2026-06-22)
- feat(kb): FluentWait + Shadow-DOM selenium-java entries + reconcile stale counts (#226, 2026-06-21)
- feat(lean): real lean generation prompt + profile-aware Stage-2 wrapper (#222, 2026-06-21)
- feat(explain): zero-token migration explainer (npm run explain) (#221, 2026-06-21)
- feat(migrate-local): batch --inputs + zero-token cost preview (#220, 2026-06-21)
- feat(profiles): lean relaxes relative-import rules → realistic lean output passes (#211, 2026-06-21)
- feat(profiles): lean relaxes page-goto-in-spec → minimal lean spec fully passes (#206, 2026-06-19)
- feat(profiles): lean output profile Phase 1 (additive, opt-in) (#204, 2026-06-19)
- feat(cli): unit tests for path derivation + scoping, and a --check preflight doctor (#202, 2026-06-19)
- feat(cli): confidence score in local migrate summary (#198, 2026-06-19)
- feat(cli): local Stage-2 migrate — run on your own test without forking CI (#196, 2026-06-19)
- feat(triage): zero-token capture-failure tool + debugging discipline (#195, 2026-06-19)
- feat(migrate): TODO discipline validator (PR #151 verify-CR root cause) (#183, 2026-06-18)

### Fixes

- fix(grounding): snapshot the page the test NAVIGATES to, not just the site root (IMP1) (#259, 2026-06-28)
- fix(pipeline): execution gate runs (--config) + BP2 live-grounding wall step + 2nd real input (#254, 2026-06-28)
- fix(ci): scope eslint + playwright --list to THIS leg's spec, not the whole tree (wave-4) (#248, 2026-06-25)
- fix(grounding): offline gate is header-aware so it engages on Cypress/Selenium plans (wave-4) (#246, 2026-06-24)
- fix(ci): bot PRs use a GitHub App token so downstream gates actually run (wave-4) (#244, 2026-06-24)
- fix(scorer): plan confidence reads the structured enum, not 'high' in prose (wave-1 #4) (#238, 2026-06-22)
- fix(scorer): provenance-aware selector quality — hallucinated canonical no longer scores like verified (wave-1 #3) (#237, 2026-06-22)
- fix(grounding): probe the emitted tree (POMs), not the bare spec — unblock the 0.69 cap (wave-1 #2) (#236, 2026-06-22)
- fix(ci): score the spec generated FOR THIS input, not the lexically-first (wave-1 #1) (#235, 2026-06-22)
- fix(evaluate): grounding-aware confidence — unverified locators can't auto-ship (#228, 2026-06-22)
- fix(rag): honest MAP@3 (remove train/test leak) + local --gate flag (#219, 2026-06-21)
- fix(evaluate): fixture-aware emitted-tree scoring + assertion floor + placeholder/roulette smells (#218, 2026-06-21)
- fix(rag): derive SHIP IT from aggregate confidence when no Verdict header (#216, 2026-06-21)
- fix(evaluate): score the whole emitted tree, not just the spec (keystone) (#215, 2026-06-21)
- fix(profiles): lean also relaxes ESLint spec restrictions (end-to-end consistency) (#212, 2026-06-21)
- fix: 8 deterministic bugs found by session self-review (#201, 2026-06-19)
- fix(plan): bump max-turns tiers +4 (ShadowDom 17/16 hit) (#194, 2026-06-18)
- fix(stage2): concurrent-migration helper EXTEND rule (PR #185 root cause) (#193, 2026-06-18)
- fix(plan): tell Sonnet not to self-validate envelope (max-turns root cause) (#187, 2026-06-18)
- fix(plan): per-input concurrency for repository_dispatch too (#179, 2026-06-18)
- fix(migrate): strip stale confidence:* label when PR is updated (mirror #166) (#177, 2026-06-17)
- fix(migrate): evaluate.ts find skips _legacy-v0.1.x/ (sibling of #175) (#176, 2026-06-17)
- fix(migrate): auto-correct sed accepts subdir Output paths (#175, 2026-06-17)
- fix(report-metrics): prefer spec-specific LOC over aggregate (#172, 2026-06-17)
- fix: rename @types/* alias to @type-defs/* (TS6137 collision) (#171, 2026-06-17)
- fix(verify): bump max-turns 25 -> 35 (CR sub-agent budget gap) (#170, 2026-06-17)

### Chores

- chore: catch capitalized Qa-master variants (final de-identification) (#269, 2026-06-29)
- chore: genericize the last 2 company mentions in the knowledge base (#268, 2026-06-29)
- chore(release): regenerate CHANGELOG + align package.json version (#209, 2026-06-19)
- chore: portability fixes + surface local Stage-2 CLI in onboarding docs (#197, 2026-06-19)

### Docs

- docs: fix count/version drift + surface the honest measured baseline (#274, 2026-06-30)
- docs: rewrite README — failure-mode-first, timeless (#266, 2026-06-29)
- docs(audit): all four remediation waves merged — remaining work is human-gated data (#251, 2026-06-25)
- docs: lead with the honest quality bar; retract the unfounded prompt-tune ban (wave-4) (#245, 2026-06-24)
- docs(audit): 96%-readiness findings, research & next-steps handoff (#239, 2026-06-22)
- docs: research — how to raise the 33% acceptable-rate (grounding is DARK) (#230, 2026-06-22)
- docs(quality): mark grounding-aware scorer lever shipped (#228) (#229, 2026-06-22)
- docs(quality): Run 2 — real batch reveals scorer/human anti-correlation (#227, 2026-06-22)
- docs(rag): honest MAP@3 status + operator commands (#225, 2026-06-21)
- docs(readme): surface adopter-facing commands + honest state update (#224, 2026-06-21)
- docs: honest measured-quality baseline (0.69 mean / 60% auto-ship) (#223, 2026-06-21)
- docs: stop claiming execution-based mutation-kill-rate as a primary signal (#217, 2026-06-21)
- docs: research note — temperature is not a variability lever here (#214, 2026-06-21)
- docs(profiles): README for the output-profile system (#213, 2026-06-21)
- docs(readme): complete local Stage-2 front-door (--check, --profile lean) (#210, 2026-06-19)
- docs(quickstart): document --check + --profile lean (#208, 2026-06-19)
- docs(adr): 0002 output profiles (lean config escape hatch — design only) (#200, 2026-06-19)
- docs: defer .claude/ structure adoption plan post-migration-stability (#174, 2026-06-17)

### Other

- Finishing touches: --isolate data-loss guard + caught-false-green showcase block (#275, 2026-06-30)
- Audit fix-wave 1: close false-accept holes + harden gates/parsers (+ fix #270 golden drift) (#273, 2026-06-29)
- Harden envelope derivation against a missing framework keyword (#272, 2026-06-29)
- Structural URL-portability gate + confidence strategy (#271, 2026-06-29)
- Backlog: B4 validator gaps + B3 batch isolation + IMP4 codemod pre-pass (#270, 2026-06-29)
- blueprint: de-identify the reference suite + rename qa-master → pwm-blueprint (#267, 2026-06-29)
- Bound every claude-code CLI call with a timeout + retry (no more infinite pipeline hang) (#265, 2026-06-29)
- Assertion-strength gate + framework-semantic detectors (B1 + B2) (#264, 2026-06-29)
- Loop tuning + defect-hunt fixes: false-green hardening, lint-repair, POM-provenance, locator cache (IMP5/6 + DEF1/2) (#263, 2026-06-29)
- Permit envelope $schema meta-key (IMP11) + verify the final repair (IMP12) — 7/7 real GitHub tests, all 3 frameworks (#262, 2026-06-29)
- Closed-loop reliability: failure-time repair grounding, self-contained auth, correct-spec resolution (IMP8–10) — validated 5/5 on real GitHub tests (#261, 2026-06-29)
- test(evaluate): unit-cover countSmells confidence-score detector (#207, 2026-06-19)
- test(profiles): regression guard for lean import-source relaxation (#205, 2026-06-19)
- test(triage): unit-cover triage-all parsers + surface migrate --check (#203, 2026-06-19)
- refactor: single source for the source-framework union (#199, 2026-06-19)
- [Migration code] inputs/bad-playwright/silent-conditionals.spec.ts (#192, 2026-06-18)
- [Migration plan] inputs/bad-playwright/silent-conditionals.spec.ts (#191, 2026-06-18)
- [Migration code] inputs/bad-playwright/nth-selectors.spec.ts (#190, 2026-06-18)
- [Migration plan] inputs/selenium-java/ExplicitWaitJupiterTest.java (#189, 2026-06-18)
- [Migration code] inputs/bad-playwright/missing-await.spec.ts (#188, 2026-06-18)
- [Migration plan] inputs/bad-playwright/missing-await.spec.ts (#186, 2026-06-18)
- [Migration plan] inputs/bad-playwright/nth-selectors.spec.ts (#184, 2026-06-18)
- [Migration code] inputs/bad-playwright/force-clicks.spec.ts (#182, 2026-06-18)
- [Migration plan] inputs/bad-playwright/force-clicks.spec.ts (#181, 2026-06-18)
- [Migration plan] inputs/cypress/checkout-flow.cy.js (#180, 2026-06-18)

<!-- AUTOGEN:CHANGELOG:END -->


## [v0.2.0] — 2026-06-10 — pwm-blueprint target architecture (full rewrite)

**Theme**: PWmodernizer now produces pwm-blueprint-tier production-grade multi-file Playwright TypeScript by default. Single-spec minimal mode (the v0.1.x default) is gone. Every migration emits a layered tree: `outputs/helper/page-object/{pages,blocks,basepage,baseblock}`, `outputs/helper/fixtures/base.fixture.ts` (single import source for `test`/`expect`), `outputs/helper/api/`, `outputs/helper/actions/`, `outputs/helper/utilities/`, `outputs/helper/test-data/`, `outputs/helper/types/` plus `outputs/tests/<feature>.spec.ts`.

This is additive ambition: keep everything v0.1.x got right (calibrated prompts, validators, cost capture, CANDOR verify with max-severity tally) and stack a pwm-blueprint-grade output layer on top.

### Added

- **`config/migration-rules.md` §1–§4 rewritten for pwm-blueprint architecture**:
...
- **`prompts/analyze.md` Step 5 rewritten for pwm-blueprint multi-file planning** — 9 sub-steps (5a–5i): Pages, Blocks, Fixtures, API wrappers, Actions, Utilities (with mandatory unit tests), Test-data mutations, Types, Spec file (and §5j split-spec). Each plan ends with a §5 summary table enumerating every file Stage 2 must emit; this feeds the envelope's `required*` arrays.
- **`prompts/generate.md` Your-task section rewritten for pwm-blueprint multi-file output** — Stage 2 emits multi-file output ALWAYS. Strict imports: `test`/`expect` only from `@fixtures/base.fixture`; path aliases mandatory; alphabetical import groups. Trivial-migration minimum is 5 files (Page + base.fixture mutation + labels mutation + spec + report), never a single bare spec.
- **`scripts/plan-envelope.schema.json` — 7 new `required*` arrays**: `requiredPages` (helper/page-object/pages/*.page.ts), `requiredBlocks` (helper/page-object/blocks/*.block.ts), `requiredApi` (helper/api/*.api.ts), `requiredActions` (helper/actions/*.ts), `requiredUtilities` (helper/utilities/*.ts), `requiredTestData` (helper/test-data/*.ts), `requiredTypes` (helper/types/{external,internal}/*.ts). Each pattern-validated against its target directory. Optional in the JSON schema (preserves v0.1.x envelope back-compat); the pwm-blueprint conformance validator enforces shape at the file level.
- **`scripts/validate-pwm-blueprint-conformance.ts` (new, ~330 LOC)** — defense-in-depth gate wired into `migrate.yml` after `plan-vs-code coverage` and before the report-metric gate. Hard-fails on:
  1. Spec imports `test`/`expect` from `@playwright/test` (KB pwm-blueprint/architecture/import-source)
  2. `PageClass`/`BlockClass` subclass declares own constructor (KB pwm-blueprint/architecture/no-constructor)
  3. Locator field without `.describe('[LABEL] …')` (KB pwm-blueprint/architecture/locator-no-describe)
  4. `expect()` inside page method without `[LABEL]` message arg (KB pwm-blueprint/architecture/expect-no-label)
  5. Relative `../` cross-helper import instead of path alias (KB pwm-blueprint/architecture/relative-imports)
  6. Type-prefix missing on locator field name (warn-only by default; block in `--strict`) (KB pwm-blueprint/architecture/naming-no-prefix)
  7. `page.goto(` in a spec file (KB pwm-blueprint/architecture/page-goto-in-spec)

  Plus a soft-fail (warn) for utilities without matching unit tests (KB pwm-blueprint/architecture/utilities-coverage).
- **`.github/workflows/migrate.yml` — pwm-blueprint conformance step** wired between `plan-vs-code coverage` and `Report-metric self-consistency`. Default mode: block-severity findings fail the workflow; warns annotate but don't block.
- **`config/knowledge-base.md` `pwm-blueprint/` namespace** — 15 KB IDs catalogue pwm-blueprint ARCHITECTURE.md anti-patterns: `import-source`, `relative-imports`, `no-constructor`, `locator-no-describe`, `expect-no-label`, `parameterised-locator-method`, `naming-no-prefix`, `nav-returns-void`, `parse-in-page-method`, `page-goto-in-spec`, `ui-data-prep`, `should-test-name`, `step-without-action`, `selector-not-testid-first` (pwm-blueprint diverges: testid-first), `foreign-framework-import`, `utilities-coverage`.

### Why no minimal mode

The v0.1.x minimal output (single `.spec.ts`, ~50 LOC) was production-validated (4/4 Playwright tests pass against live SUT). But it doesn't represent senior-SDET production engineering. A real test suite has layered POMs, API-prep, fixtures, utilities. PWmodernizer's value proposition is "generate the kind of test a senior SDET would write" — that demands the pwm-blueprint layout, not a 50-LOC sketch. We're betting on quality over backwards-compat.
...
12 plan PRs (#19, #20, #27–#31, #33–#37) were drafted under v0.1.x conventions. They CAN merge as-is and produce v0.1.x-shaped Stage 2 output (the prompts default to pwm-blueprint; the existing plan PRs predate that switch). For the cleanest result, re-trigger Stage 1 on each input after v0.2.0 merges so the plan is pwm-blueprint-shaped first.

### v0.1.x corpus preserved

The v0.1.x-shaped generated specs in `outputs/tests/*.spec.ts` and envelopes in `outputs/plans/*.envelope.json` remain on `main` as historical corpus. The git tags `v0.1.0` and `v0.1.1` mark the v0.1.x snapshot — `git checkout v0.1.1` recovers the full pre-rewrite state at any time. The pwm-blueprint conformance validator will flag the v0.1.x specs (page.goto in spec, no Pages, etc.) — that's expected; they're frozen historical artifacts, not future targets.

### Empirical validation status

End-to-end validation of the pwm-blueprint Stage 2 output is **deferred to v0.2.1**. The first pwm-blueprint Stage 2 run will be triggered immediately after this PR merges; iterative prompt calibration based on what Sonnet actually emits is expected (same loop pattern as v0.1.x verify-pipeline closure took today).
