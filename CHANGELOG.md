...
- fix(plan-code-coverage): mirror PR #156 qa-master path fallback (#159, 2026-06-16)
- fix(envelope-schema): allow qa-master POM paths in requiredPOMs (pairs with #156) (#157, 2026-06-16)
- fix(envelope): qa-master path fallback for legacy v0.1.x plans (#156, 2026-06-16)
- fix(migrate): per-input concurrency on workflow_dispatch (mirror #139) (#150, 2026-06-16)
- fix(qa-master-conformance): exclude _legacy-v0.1.x/ from walk (third validator) (#148, 2026-06-16)
