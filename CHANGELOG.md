...
<!-- Generated by scripts/generate-changelog.ts on 2026-06-19. -->
...
- feat(migrate): auto-strip @types/ runtime-import prefix (KB-1.1.27 pre-flight) (#169, 2026-06-17)
- feat(kb): KB-1.1.27 @types/ prefix runtime import drift (#168, 2026-06-17)
- feat(kb): KB-1.1.26 wrong-import-source anti-pattern (#167, 2026-06-17)
- feat(plan): adaptive max-turns per input complexity (research-backed) (#143, 2026-06-16)
- feat(ci): auto-label PRs by area of change (#136, 2026-06-16)
- feat(migrate): wire helper-usage gate into Stage 2 (warn-only, stacked on #134) (#135, 2026-06-16)
- feat(validate): unreferenced API helper gate (PR #126 SDET finding → static check) (#133, 2026-06-16)
- feat(verify): PR comment when transient retry dispatches (#131, 2026-06-16)
- feat(ci): timeout-minutes cap on every Claude LLM step (#130, 2026-06-16)
- feat(observability): Claude crash diagnostics for plan + migrate (#129, 2026-06-16)
- feat(verify): sub-agent crash diagnostics on failure (#128, 2026-06-16)
- feat(calibrate): selenium-java-conformance validator + first fixture (#119, 2026-06-16)
- feat(calibrate): cypress conformance fixture pair #04 (login-flow) (#118, 2026-06-16)
- feat(ci): MAP@3 retrieval-quality gate in regression matrix (#117, 2026-06-16)
- feat(rag): MAP@3 leave-one-out evaluator - Phase 1 final exit axis (#116, 2026-06-16)
- feat(rag): variance report + Phase 1 exit gate (#115, 2026-06-16)
- feat(dashboard): RAG retrieval panel reading Phase 1 telemetry (#114, 2026-06-16)
- feat(rag): metrics DB schema migration for Phase 1 telemetry (#113, 2026-06-16)
- feat(rag): Phase 1 calibration fixtures - 5 rag-bm25 in runner (#112, 2026-06-16)
- feat(rag): Phase 1 wiring - STAGE1_RAG env var + plan.yml retrieval step (#111, 2026-06-16)
- feat(rag): Phase 1 BM25 foundation - index + retrieval + render + anchors (#110, 2026-06-16)
- feat(pilot): operator-facing pilot kit + dry-run preflight (#109, 2026-06-16)
- feat(caching): Anthropic prompt caching PoC on verify stage (#106, 2026-06-15)
- feat(dashboard): cost-forecast + per-outcome + ROI panels (#105, 2026-06-15)
- feat(onboarding): 5-minute first migration via npm run try-it (#104, 2026-06-15)
- feat(calibrate): conformance fixture pair #02 — cypress intercept + sel-py form-validation (#102, 2026-06-15)
...
- fix(verify): replace prior verify:* labels instead of stacking (PR #68 finding) (#166, 2026-06-17)
- fix(plan-code-coverage): mirror PR #156 pwm-blueprint path fallback (#159, 2026-06-16)
- fix(envelope-schema): allow pwm-blueprint POM paths in requiredPOMs (pairs with #156) (#157, 2026-06-16)
- fix(envelope): pwm-blueprint path fallback for legacy v0.1.x plans (#156, 2026-06-16)
- fix(migrate): per-input concurrency on workflow_dispatch (mirror #139) (#150, 2026-06-16)
- fix(pwm-blueprint-conformance): exclude _legacy-v0.1.x/ from walk (third validator) (#148, 2026-06-16)
- fix(validators): exclude _legacy-v0.1.x/ from spec walks (third real gap today) (#147, 2026-06-16)
- fix(plan-code-coverage): mirror PR #142 — test_ prefix drop (second validator) (#144, 2026-06-16)
- fix(plan-envelope-validate): drop leading test_ prefix on python inputs (test_employees.py → employees.spec.ts) (#142, 2026-06-16)
- fix(plan): per-input concurrency on workflow_dispatch (4 parallel → 2 cancelled gap) (#139, 2026-06-16)
- fix(verify): grant actions:write so transient retry can dispatch (#127, 2026-06-16)
- fix(migrate): bump Stage 2 max-turns 40 -> 50 for cypress complexity (#125, 2026-06-16)

### Chores

- chore: portability fixes + surface local Stage-2 CLI in onboarding docs (#197, 2026-06-19)
- chore: add .gitattributes (LF + linguist-generated/vendored hints) (#138, 2026-06-16)
- chore: close ROADMAP v0.5+v1.0, wire sel-py runner, +2 fixtures, v0.3 narrative (#108, 2026-06-15)
- chore(changelog): auto-regenerate from merged PRs (#99, 2026-06-15)
...
- docs(troubleshooting): bot-created PR checks stuck action_required + GitHub App recipe (#140, 2026-06-16)
- docs(troubleshooting): silent Claude crash + retry 403 + timeout cap (#132, 2026-06-16)
- docs(adr): 0001 — self-improvement via RAG over past migrations (#107, 2026-06-15)
...
- [Migration plan] inputs/bad-playwright/silent-conditionals.spec.ts (#160, 2026-06-17)
- [Migration plan] inputs/bad-playwright/nth-selectors.spec.ts (#155, 2026-06-17)
- [Migration plan] inputs/bad-playwright/missing-await.spec.ts (#154, 2026-06-17)
- [Migration plan] inputs/bad-playwright/force-clicks.spec.ts (#153, 2026-06-17)
- [Migration plan] inputs/cypress/checkout-flow.cy.js (#146, 2026-06-17)
- [Migration plan] inputs/selenium-python/test_employees.py (#141, 2026-06-16)
- perf(verify): enable npm cache on setup-node (last cache gap) (#137, 2026-06-16)
- [Migration plan] inputs/cypress/wishlist.cy.js (#124, 2026-06-16)
- input(cypress): wishlist add/remove flow (#123, 2026-06-16)
- [Migration code] inputs/bad-playwright/search-filters.spec.ts (#122, 2026-06-17)
- [Migration plan] inputs/bad-playwright/search-filters.spec.ts (#121, 2026-06-16)
- input(bad-playwright): storefront search-filter flow (#120, 2026-06-16)
