# Provenance: PageLoadTimeoutJupiterTest.java

## Source
- **Upstream:** [bonigarcia/selenium-webdriver-java](https://github.com/bonigarcia/selenium-webdriver-java)
- **License:** Apache-2.0
- **Path in upstream:** `selenium-webdriver-junit5/src/test/java/io/github/bonigarcia/webdriver/jupiter/ch04/timeouts/PageLoadTimeoutJupiterTest.java`
- **Fetched on:** 2026-06-09 via `gh api` (P3 batch 2)

## Topic
- **Anti-pattern domain:** Timeouts
- **Summary:** Page-load timeout config (driver.manage().timeouts().pageLoadTimeout)
...
- Expected output: `outputs/tests/pageloadtimeoutjupitertest.spec.ts` per kebab-case convention
