 ...
 *
 * v0.2.0 pwm-blueprint baseline shell — checked into main so specs always have a valid
 ...
 * imports `test` + `expect` from here. `validate-pwm-blueprint-conformance.ts` enforces this.
 */
