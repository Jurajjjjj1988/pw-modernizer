...
import { AddCookiesPage } from "@page-object/pages/add-cookies.page";
...
type Fixtures = { addCookiesPage: AddCookiesPage };

const test = base.extend<Fixtures>({
  addCookiesPage: async ({ page }, use) => use(new AddCookiesPage(page)),
});
