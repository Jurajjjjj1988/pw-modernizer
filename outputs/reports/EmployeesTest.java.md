...
## Source → Target
- Source: `inputs/selenium-java/EmployeesTest.java` (41 LOC)
- Output: `outputs/tests/employees.spec.ts` (42 LOC)
- LOC delta: +1
...
- Plan confidence: 1 high / 3 med / 6 low → avg 0.40

### Confidence breakdown
| Signal | Value | Weight | Contribution |
|---|---|---|---|
| Plan confidence | 0.40 | 0.40 | 0.160 |
...
3. If verify report exists (`outputs/reports/EmployeesTest.java-verify.md`), read the disagreements section.
