# Migration report: force-clicks.spec.ts

## Source → Target
- Source: `inputs/bad-playwright/force-clicks.spec.ts` (21 LOC)
- Output: `outputs/tests/_legacy-v0.1.x/using_selenium_tests.spec.ts` (29 LOC)
- LOC delta: +8
...
- Plan confidence: 7 high / 0 med / 1 low → avg 0.90

### Confidence breakdown
| Signal | Value | Weight | Contribution |
|---|---|---|---|
| Plan confidence | 0.90 | 0.40 | 0.360 |
...
3. If verify report exists (`outputs/reports/force-clicks.spec.ts-verify.md`), read the disagreements section.
